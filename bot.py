...
VALID_CHOICES = {
    ...
    "osb_inpainting_method": {"flux_klein_9b", "flux_klein_4b", "flux_kontext", "lama", "lama_large", "opencv", "none"},
...
FIELD_REGISTRY = {
    ...
    'osb_inpainting_method': {'group': 'osb', 'label': '🎨 OSB Inpainting Method', 'vtype': 'val', 'argtype': 'str', 'default': 'flux_klein_4b', 'choices': ['flux_klein_9b', 'flux_klein_4b', 'flux_kontext', 'lama', 'lama_large', 'opencv', 'none'], 'hint': None},
